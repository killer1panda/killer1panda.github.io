...
async function testIndex4() {
    ...
    try {
        ...
        await page.goto('http://localhost:8002/index4.html', { waitUntil: 'networkidle2' });

        // Wait for page to load
        await new Promise(resolve => setTimeout(resolve, 3000));

        // Take a screenshot first
        await page.screenshot({ path: 'index4_test.png', fullPage: true });
        console.log('✓ Screenshot saved as index4_test.png');
